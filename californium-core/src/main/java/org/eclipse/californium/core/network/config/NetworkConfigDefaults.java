...
public class NetworkConfigDefaults {
	...
	public static final boolean DEFAULT_DTLS_CONNECTION_ID_HANDSHAKE = false; // not used during handshake itself
	/*
	...
	public static void setDefaults(final NetworkConfig config) {
		...
		config.setBoolean(Keys.DTLS_CONNECTION_ID_HANDSHAKE, DEFAULT_DTLS_CONNECTION_ID_HANDSHAKE);
