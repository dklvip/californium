...
public class CredentialsUtil {
	...
	public static final String OPT_CID_HANDSHAKE = "CID+:";
	...
	private static final String[] OPT_CID_LIST = {OPT_CID, OPT_CID_HANDSHAKE};
	...
	public static void setupCid(String[] args, DtlsConnectorConfig.Builder builder) {
		for (String mode : args) {
			...
			if (opt != null) {
				...
				if (opt == OPT_CID_HANDSHAKE) {
					builder.setConnectionIdUsedInHandshake(true);
					System.out.println("Use cid in handshake");
				}
			}
		}
	}
